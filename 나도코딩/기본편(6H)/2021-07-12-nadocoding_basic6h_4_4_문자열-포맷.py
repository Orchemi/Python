...
# 3. {} 방법
print("나는 {}살입니다.".format(20))  # .format() 내의 값을 중괄호 내에 삽입 후 출력
...
print("나는 {age}살이며, {color}색을 좋아해요.".format(color = "빨간", age = 20))  # 순서와 관계 없이 정의된 변수에 영향


# 5. 직접 변수 방법 (python v3.6 이상~)
age = 20
color = "빨간"
print(f"나는 {age}살이며, {color}색을 좋아해요.")  # f를 문자열 앞에 붙이면 문서 내 변수 호출해 사용 가능
